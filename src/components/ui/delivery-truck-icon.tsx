...
export const DeliveryTruck = ({className, stroke, height, width}:IconProps) => (
      <svg xmlns="http://www.w3.org/2000/svg" width={width || "1em"} height={height || "1em"} viewBox="0 0 24 24" className={className}>
    <g fill="none" stroke={stroke} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" color="currentColor">
